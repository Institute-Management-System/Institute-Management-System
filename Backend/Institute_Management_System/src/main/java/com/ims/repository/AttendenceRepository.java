...
public interface AttendenceRepository extends JpaRepository<Attendence, Long> {
	...
	@Query("""
	        SELECT new com.ims.dto.TeacherMyAttendanceDTO(
	            a.attendanceDate,
	            a.course.name,
	            a.subject.name,
	            a.status
	        ...
	        FROM Attendence a
	        WHERE a.user.id = :teacherId
	          AND a.user.role = com.ims.entity.Role.TEACHER
	        ORDER BY a.attendanceDate DESC
	    """)
	    List<TeacherMyAttendanceDTO> findMyAttendance(
        ...
        // Total attendance records in a date range
        @Query("""
                            SELECT COUNT(a)
                            FROM Attendence a
        ...
        // Total PRESENT records in a date range
        @Query("""
                            SELECT COUNT(a)
                            FROM Attendence a
